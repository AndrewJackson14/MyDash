  ...
  return <div style={{ display: "flex", height: "100vh", background: `${Z.bg} url('${starsBg}') center/cover no-repeat fixed`, color: Z.tx, fontFamily: BODY }}>
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <main data-main style={{ flex: 1, overflow: "auto", padding: pg === "dashboard" ? 0 : 28, background: "transparent" }}>
        ...
        {show("circulation") && <div style={vis("circulation")}><Circulation pubs={pubs} issues={issues} subscribers={subscribers} setSubscribers={setSubscribers} dropLocations={dropLocations} setDropLocations={setDropLocations} dropLocationPubs={dropLocationPubs} setDropLocationPubs={setDropLocationPubs} drivers={drivers} setDrivers={setDrivers} driverRoutes={driverRoutes} setDriverRoutes={setDriverRoutes} routeStops={routeStops} setRouteStops={setRouteStops} bus={bus} /></div>}
