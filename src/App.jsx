...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (pg === 'billing') { loads.push(appData.loadBilling?.()); loads.push(appData.loadContracts?.()); }
