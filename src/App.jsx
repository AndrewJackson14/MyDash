  ...
  return <PageHeaderProvider>
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <main data-main style={{ flex: 1, overflow: "auto", padding: pg === "dashboard" ? 0 : 28, background: "transparent" }}>
        ...
        {show("schedule") && <div style={vis("schedule")}><IssueSchedule isActive={pg === "schedule"} pubs={pubs} issues={jIssues} sales={jSales} stories={jStories} publicHolidays={appData.publicHolidays || EMPTY_ARR} loadHolidays={appData.loadHolidays} onNavigate={handleNav} onOpenIssue={setIssueDetailId} /></div>}
        ...
        {show("layout") && <div style={vis("layout")}><IssueLayoutConsole isActive={pg === "layout"} deepLink={deepLink} currentUser={currentUser} pubs={pubs} issues={jIssues} team={team} sales={jSales} stories={jStories} clients={jClients} setStories={setStories} onNavigate={handleNav} /></div>}
        ...
        {show("collections") && <div style={vis("collections")}><CollectionsCenter isActive={pg === "collections"} currentUser={currentUser} invoices={jInvoices} clients={jClients} payments={payments} /></div>}
