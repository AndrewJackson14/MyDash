  ...
  return <div style={{ display: "flex", height: "100vh", background: Z.bg, color: Z.tx, fontFamily: BODY }}>
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <main data-main style={{ flex: 1, overflow: "auto", padding: pg === "dashboard" ? 0 : 28, background: "transparent" }}>
        ...
        {show("billing") && <div style={vis("billing")}><Billing jurisdiction={jurisdiction} clients={jClients} sales={jSales} pubs={pubs} issues={jIssues} proposals={jProposals} invoices={jInvoices} setInvoices={setInvoices} payments={payments} setPayments={setPayments} bus={bus} team={team} subscribers={subscribers} subscriptionPayments={appData.subscriptionPayments || []} contracts={appData.contracts || []} loadContracts={appData.loadContracts} bills={appData.bills || []} insertBill={appData.insertBill} updateBill={appData.updateBill} deleteBill={appData.deleteBill} /></div>}
