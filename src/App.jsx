  ...
  return <div style={{ display: "flex", height: "100vh", background: Z.bg, color: Z.tx, fontFamily: BODY }}>
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <main data-main style={{ flex: 1, overflow: "auto", padding: pg === "dashboard" ? 0 : 28, background: "transparent" }}>
        ...
        {show("contracts") && <div style={vis("contracts")}><Contracts contracts={appData.contracts || []} clients={clients} pubs={pubs} sales={sales} team={team} jurisdiction={jurisdiction} currentUser={currentUser} onNavigate={handleNav} loadContracts={appData.loadContracts} contractsLoaded={appData.contractsLoaded} /></div>}
        ...
        {show("calendar") && <div style={vis("calendar")}><CalendarPage clients={clients} sales={sales} issues={issues} pubs={pubs} team={team} currentUser={currentUser} stories={stories} bus={bus} onNavigate={handleNav} /></div>}
