...
export const ROLE_DEFAULTS = {
  ...
  "Content Editor": ["dashboard", "calendar", "editorial", "flatplan", "medialibrary", "social_posts"],
  "Managing Editor": ["dashboard", "calendar", "editorial", "flatplan", "medialibrary", "social_posts"],
