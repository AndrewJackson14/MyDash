...
// Slug fetched on click if useAppData's `clients` shape doesn't
// already carry it. Wrapped as a component so the network call is
// deferred until the rep actually wants to use it.
const PORTAL_BASE = "https://portal.13stars.media";

function ViewAsCustomerLink({ clientId, clientSlug }) {
...
const ClientProfile = ({
  ...
  return <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
    ...
    {/* Phase F: portal staff support view. Opens portal.13stars.media
        in support mode (read-only banner, write actions disabled).
        Slug fetched on click in case useAppData's clients shape
