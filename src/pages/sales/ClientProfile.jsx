          ...
          {emailLog.length === 0 ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 3, maxHeight: 220, overflowY: "auto" }}>
              {emailLog.map(e => {
                ...
                const statusColor = isInbound ? (Z.ac || "#3b82f6")
                  : e.status === "sent" ? Z.go
                ...
                return <div key={e.id} style={{ padding: "7px 10px", background: isInbound ? (Z.ac || "#3b82f6") + "08" : Z.bg, borderRadius: Ri, borderLeft: `2px solid ${statusColor}` }}>
