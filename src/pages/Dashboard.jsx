...
const Dashboard = ({
  ...
  return <><div style={{ display: "flex", flexDirection: "column" }}>
    ...
    <RevenueCommandBar glass={glass} cards={[
      ...
      { label: "AR 60+ Days", value: billingLoaded ? fmtCurrency(overdueBalance) : "—", color: overdueInvCount > 0 ? Z.da : Z.go, tags: ["financials"], sub: billingLoaded ? (overdueInvCount > 0 ? `${overdueInvCount} invoice${overdueInvCount > 1 ? "s" : ""} past 60 days` : "All current") : "Loading…", onClick: () => onNavigate?.("billing") },
