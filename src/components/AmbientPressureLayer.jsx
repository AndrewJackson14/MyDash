...
const BLUE = { r: 59, g: 130, b: 246 };       // var(--action) — serene blue
...
export default function AmbientPressureLayer({ pressure = 20, serenityColor = "blue" }) {
  ...
  const { color, alpha, baseDuration } = useMemo(() => {
    ...
    const alphaRamp = isDark ? 0.13 : 0.15;
    const alpha = alphaBase + eased * alphaRamp;  // dark: 0.08→0.21, light: 0.10→0.25
