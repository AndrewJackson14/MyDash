// ============================================================
// SendTearsheetModal — shared component. Sales/Cami fire this
// from any per-sale surface to email a client a branded link to
// their public tearsheet portal (/tearsheet/<token>). Calls the
// send-tearsheet edge function (P5f) which sends via Gmail OAuth
// and logs to email_log with ref_type='tearsheet'.
// ============================================================
...
export default function SendTearsheetModal({ client, sale, onClose }) {
  ...
  return (
    <div onClick={() => !sending && onClose()} style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ fontSize: FS.sm, color: Z.tm, marginBottom: 14 }}>To {client?.name || "client"}{sale.page ? ` · Page ${sale.page}` : ""}</div>
